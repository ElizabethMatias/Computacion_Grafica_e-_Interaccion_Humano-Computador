...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		modelTemp = model = glm::translate(model, glm::vec3(1.5f, 0.0f, 0.0f));//checkpoint guardar la translacion del opbjeto 
		...
		model = glm::rotate(model, glm::radians(codo), glm::vec3(0.0f, 1.0, 0.0f));//Codo marcar el pivote
		...
		//////Dedo 4
		model = glm::translate(modelTemp2, glm::vec3(0.20f, -0.15f, -0.375f));
